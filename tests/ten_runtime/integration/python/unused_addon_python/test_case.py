...
def test_unused_addon_python():
    ...
    if not is_started:
        print("The unused_addon_python is not started after 30 seconds.")
    ...
    try:
        ...
        if not is_stopped:
            print("The unused_addon_python can not stop after 30 seconds.")
            server.kill()
