"""
Test call_api_during_deiniting_go.
"""
...
def test_call_api_during_deiniting_go():
    ...
    app_dir_name = "call_api_during_deiniting_go_app"
    ...
    if sys.platform == "win32":
        print("test_call_api_during_deiniting_go doesn't support win32")
        assert False
        ...
        my_env["DYLD_LIBRARY_PATH"] = os.path.join(
            base_path,
            (
                "call_api_during_deiniting_go_app/ten_packages/"
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                (
                    "call_api_during_deiniting_go_app/ten_packages/system/"
    ...
    if not is_started:
        ...
        print("The exit code of call_api_during_deiniting_go: ", exit_code)
