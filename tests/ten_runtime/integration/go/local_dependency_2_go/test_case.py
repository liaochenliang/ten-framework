...
def test_local_dependency_2_go():
    ...
    app_dir_name = "local_dependency_2_go_app"
    ...
    if not is_started:
        print("The local_dependency_2_go is not started after 30 seconds.")

        server.kill()
        exit_code = server.wait()
        print("The exit code of local_dependency_2_go: ", exit_code)
